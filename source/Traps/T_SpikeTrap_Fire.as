package  {
	...
	public class T_SpikeTrap_Fire extends MovieClip implements ITrap, IUpdatable, IPurchasable, IAbility {
		...
		public function T_SpikeTrap_Fire(mg:MasterGrid): void {
			
			gotoAndStop(1);
			_masterGrid = mg;
			isSet = true;
			_setTimer = _timerLimit;
			_weapon = Weapons.trap_Spikes_Fire;
		}
		...
		public function calculate(adv:IAdventurer) : void {
			...
			if (damage > 0) {
				if (adv.calculateDamage(damage, false) == false) {	
					...
					_masterGrid.gameplayScreen.dm.addPoison(adv, 10, 2);
				}*/
			}
		}
		...
		public function abilityText(parentUnit:*) : String {
			return String("Fire Spiksdfdfes:\n(" + _damage + ")  damage");
		}
