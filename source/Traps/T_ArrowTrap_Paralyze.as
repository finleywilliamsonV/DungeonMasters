package {
	...
	public class T_ArrowTrap_Paralyze extends MovieClip implements ITrap, IUpdatable, IPurchasable {
		...
		private var _goldCost: int = 100
		private var _ui_name:String = "Paralysis Arrow";
		...
		public function T_ArrowTrap_Paralyze(mg: MasterGrid): void {

			gotoAndStop(1);
			_masterGrid = mg;
			isSet = true;
			_setTimer = _timerLimit;
			_weapon = Weapons.trap_Arrow_Paralyze;
		}
