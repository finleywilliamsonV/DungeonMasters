package {
	...
	public class T_ArrowTrap_Poison extends MovieClip implements ITrap, IUpdatable, IPurchasable {
		...
		public function T_ArrowTrap_Poison(mg: MasterGrid): void {

			gotoAndStop(1);
			_masterGrid = mg;
			isSet = true;
			_setTimer = _timerLimit;
			_weapon = Weapons.trap_Arrow_Poison;
		}
